...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_8lfg8mj', 'template_rlvtq6d', form.current, 'cpYS6HkMIJfQ754QH')
    e.target.reset()
  };
                ...
                <div className="contact__content">
                    ...
                    <div className="contact__info">
                        <div className="contact__card">
                            ...
                            <span className="contact__card-data">Sahilwagh142@gmail.com</span>
                        ...
                        <div className="contact__card">
                            ...
                            <span className="contact__card-data">9324235779</span>
                        ...
                        <div className="contact__card">
                            ...
                            <span className="contact__card-data">Sahilwagh03</span>
